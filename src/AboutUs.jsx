...
function AboutUs() {
  return (
    <div className="about-us">
      <p className="about-tagline">Welcome to Paradise Nursery, where green meets serenity!</p>
      ...
      <p>
        ...
        support you every step of the way. Feel free to explore our collection, ask questions, and let us
